...
System.out.println("NAME \t\t AC_NUM \t\t   DEPOSIT \t\t WITHDRAW \t\t TRANSFER \t\t TOTAL BALANCE");
System.out.println(name+"\t\t"+ac_No+"\t\t\t"+deposit+"\t\t"+withdraw+"\t\t\t"+transfer+"\t\t\t"+totalBalance);
}

}

//main class
public class Bank_Application_Project{
...
Bank_Application_Project app = new Bank_Application_Project(); //object creation for main class
...
//screen display and perform operations
 public void dashBoard(Banking_Data data){
...
//set vamsi details through user defined class
 public void setVamsi(Banking_Data data){
...
//set krishna details through user defined class
 public void setKrishna(Banking_Data data){
...
public void getProfile(Banking_Data data){
	data.getBankName();
	data.getName();
	data.getAcNo();
	data.getAccountType();
...
public void getTransaction(Banking_Data data){
	data.getName();
	data.getAcNo();
	data.getDeposit();
	data.getWithdraw();
...
public void methodBalance(Banking_Data data){
	data.setDeposit(0.0);
...
public void methodDeposit(Banking_Data data){
...
public void methodWithdraw(Banking_Data data){
...
public void methodTransfer(Banking_Data data){
...
//method for change password used in switch case
 public void changePassword(Banking_Data data){
	 String vPassword = "java@7799";
	 String uPassword = "Tech@143";
...
public void methodEminities(Banking_Data data){
...
public void methodExit(Banking_Data data){
